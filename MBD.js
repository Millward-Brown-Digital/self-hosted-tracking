...
function MBD(settings) {
    ...
    // copy defaults and override with settings
    ...
    this.RecentlyInvited = function (campaignId) {
        return (new Date()).getTime() - me.GetLastInviteDate(campaignId) < (me.minutesBetweenInvites * 1000 * 60);
    }

    this.AlreadyInvited = function (campaignId) {
        return me.GetLastInviteDate(campaignId)!==undefined;
    }
    ...
    this.SetLastInviteDate = function (campaignId) {
        ...
        me.SetData(data);
        me.Log('Last invite date set for campaign ' + campaignId);
        me.Log(data);
    }

    this.GetLastInviteDate = function (campaignId) {
        return me.GetData().invitedCampaigns[campaignId];
    }
    ...
    this.ShowInvite = function (campaignId) {
        ...
        if (invite) {
            ...
            me.SetLastInviteDate(campaignId);
